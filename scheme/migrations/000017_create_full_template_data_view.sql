...
select tc.contract_id,
       ...
       jsonb_build_object(
               ...
               'execution_date',
               TO_CHAR((tc.execution_date AT TIME ZONE 'UTC' AT TIME ZONE 'Europe/Moscow'), 'dd.mm.yyyy'),
               'expiration_date',
               TO_CHAR((tc.expiration_date AT TIME ZONE 'UTC' AT TIME ZONE 'Europe/Moscow'), 'dd.mm.yyyy'),
